...
NODE_DISPLAY_NAME_MAPPINGS = {
    "LayerUtility: LoadJoyCaption2Model": "LayerUtility: Load JoyCaption2 Model(Advance)",
    "LayerUtility: JoyCaption2Split": "LayerUtility: JoyCaption2 Split(Advance)",
    "LayerUtility: JoyCaption2": "LayerUtility: JoyCaption2(Advance)",
    "LayerUtility: JoyCaption2ExtraOptions": "LayerUtility: JoyCaption2 Extra Options(Advance)"
}